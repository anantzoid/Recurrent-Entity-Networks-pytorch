...
def main(args):
    ...
    model = MemN2N({"num_vocab":train_dataset.num_vocab, "embedding_dim": 100,
        "sentence_size":train_dataset.sentence_size}) 
    ...
    loss = torch.nn.CrossEntropyLoss(size_average=False).to(args.device)
