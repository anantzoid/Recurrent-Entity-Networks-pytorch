...
class SmallModel(torch.nn.Module):
    def __init__(self, vocab_size, embed_size):
        ...
        self.lin.weight.data.normal_(0.0, 0.1)
        self.lstm._parameters['weight_ih_l0'].data.normal_(0.0, 0.1)
        self.lstm._parameters['weight_hh_l0'].data.normal_(0.0, 0.1)
...
class REN1(nn.Module):
    ...
    def forward(self, story, query):
        ...
        initial_state, _ = self.lstm(story_embedded)
        """ 
